...
Original_Mask_img_path = '../../data/Training_Disc_Cup_Masks/'

Image_save_path = '../../data/training_crop_cartesian_s460/data/'
MaskImage_save_path = '../../data/training_crop_cartesian_s460/label/'
